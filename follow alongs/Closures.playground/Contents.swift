...
// Verbose Closure
//func combineForOver5(runningTotal: Int, currentValue: Int) ->Int{
...
var numValuesOver9 = values.reduce(0) {
    return $1 > 9 ? $0 + 1: $0} //if you remove the return it becomes an implicit return
    //$0 and $1 become place holders for the inputs of the function
